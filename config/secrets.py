...
username = "cesardjm2003@gmail.com"       # Enter your username in the quotes
password = "Sprintcup132#487"           # Enter your password in the quotes
...
llm_api_url = "https://generativelanguage.googleapis.com/"       # Examples: "https://api.openai.com/v1/", "http://127.0.0.1:1234/v1/", "http://localhost:1234/v1/", "https://api.deepseek.com", "https://api.deepseek.com/v1"
'''
...
llm_api_key = "AQ.Ab8RN6IkJSOXCZZogFmZUF_myIaE8WneNVhtV30Jkelm_y-7yA"              # Enter your API key in the quotes, make sure it's valid, if not will result in error.
'''
...
llm_model = "gemini-2.5-pro"          # Examples: "gpt-3.5-turbo", "gpt-4o", "llama-3.2-3b-instruct", "qwen3:latest", "gemini-pro", "gemini-1.5-flash", "gemini-2.5-flash", "deepseek-llm:latest"
